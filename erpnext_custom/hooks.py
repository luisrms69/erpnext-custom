...
app_description = "Campos custom de erpnext marcados para exportacion a traves de fixture"
...
fixtures = [
	...
	"filters": {
		"name": ["in", "Socio, Presidente Consejo Administracion, Secretario Consejo de Administracion, Tesorero Consejo de Administracion, Meetings Manager, Meeting User"]
              }
       }
